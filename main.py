...
async def paraphrase_text(text: str) -> str:
    ...
    data = {
        ...
        "messages": [{
            "role": "user",
            "content": f"Перепиши цей телеграм-пост у крипто-стилі... Мова посту українська... Якщо в оригінальному пості є нумерований список збережи його... Назва нумерованого посту Що робити... Назви крипто бірж пиши правильно згідно з оіційним позіціонуванням... Оригінальний пост: {text}"
        }]
    }
